  ...
  return (
    <div className="manual-container">
      <section className="manual-section">
        ...
        <img src="/for manual/login_page_1.png" alt="Login Page Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/registrarion_page_2.png" alt="Registration Page Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/regestration_info_ex_3.png" alt="Registration Info Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/login_usr_5.png" alt="Login Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/monitor_main_page_6.png" alt="Monitor Bar Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/map_view_7.png" alt="Map View Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/map_side_bar_8.png" alt="Map Sidebar Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/detailed_sidebar_8.png" alt="Detailed Sidebar Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/picking_loc_on_the_map_9.png" alt="Pick Location Screenshot" />
        <img src="/for manual/cross_on_the_map_10.png" alt="Cursor Change Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/obj_preview_11.png" alt="Object Preview Screenshot" />
        <img src="/for manual/create_pbg_12.png" alt="Create Object Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/click_on_the_obj_12.png" alt="Click on Object Screenshot" />
        <img src="/for manual/editing_obj_13.png" alt="Editing Object Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/main_page_after_new_obj_14.png" alt="Updated Map Screenshot" />
      </section>
      ...
      <section className="manual-section">
        ...
        <img src="/for manual/profile_15.png" alt="Profile Tab Screenshot" />
      </section>
    </div>
  );
};
